...
test('retired application and installers are absent; old bookmarks redirect',async()=>{
 ...
 for(const path of ['potato','suite','products/operations','suite/products/operations','demo','studio'])assert.match(await readFile(`dist/${path}/index.html`,'utf8'),/http-equiv="refresh".*potato-spatial-7#plant/);
